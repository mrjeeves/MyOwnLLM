...
| `DEFAULT_SIGNALING_REDUNDANCY`         | 8                    | Built-in Nostr relay count (Trystero default is 5)            |
...
| Rate-limited Nostr relay (`relay.damus.io` "noting too much") | Socket sits in CONNECTING; warn log     | Other 7 relays in redundancy 8 carry traffic; rejoin throttled to never < 90s           | `pollSignalingRelays`, redundancy 8    |
